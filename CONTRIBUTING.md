...
1. Check the [issue tracker](https://github.com/Zyphria/solana-toolkit) to see if it has already been reported.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Zyphria/solana-toolkit.git
   ```
